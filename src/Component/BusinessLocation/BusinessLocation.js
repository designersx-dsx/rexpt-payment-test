...
//         <input type="text" placeholder="First Address" className={styles.input} />

//         <label className={styles.label}>Address line 2</label>
//         <input type="text" placeholder="Second Address" className={styles.input} />


//         <div className={styles.Btn} >
//           <button type="submit" onClick={handleContinue}>Continue
