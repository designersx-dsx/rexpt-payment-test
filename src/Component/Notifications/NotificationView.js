...
// //   try {
// //     // Example: await axios.post(`/api/notifications/${id}/seen`);
...
//   const [visibleCount, setVisibleCount] = useState(30); // Initial 50 notifications
...
//     setNotificationStatus(notifications?.map((n) => ({ id: n.id, isRead: n.isRead || false })))
//   },[notifications])
...
//             const isRead = notificationStatus.find((n) => n.id === notification.id)?.isRead || false;
//             return (
//               <div
//                 key={notification.id}
...
//                     // >
//                      <span onClick={()=>navigate(notification.clickAction)} className={styles.actionLink}>Take Action</span>
