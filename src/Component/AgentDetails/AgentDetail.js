            ...
            <header className={styles.header}>
              ...
              <div className={styles.notifiMain}>
                ...
                <div className={styles.notificationIcon} onClick={handleLogout}>
                  ...
                  >
                    <path
                      d="M12.9993 28.0034C6.38263 28.0034 1 22.7239 1 16.2355C1 10.6955 5.00696 5.85142 10.5273 4.71703C10.8152 4.65596 11.1024 4.83922 11.1634 5.12475C11.2244 5.40961 11.0381 5.6887 10.7476 5.74853C5.72168 6.78065 2.07399 11.1914 2.07399 16.2355C2.07399 22.1426 6.97534 26.9488 12.9993 26.9488C19.0239 26.9488 23.9246 22.1426 23.9246 16.2355C23.9246 11.1676 20.2566 6.75231 15.2025 5.7382C14.9113 5.67967 14.7238 5.40125 14.7842 5.11634C14.8419 4.83149 15.1199 4.64947 15.4176 4.7054C20.97 5.81981 25 10.6691 25 16.2354C24.9999 22.7239 19.6167 28.0034 12.9993 28.0034Z"
                      fill="#222222"
                      stroke="#222222"
                      stroke-width="0.4"
                    />
                    <path
                      d="M13.0292 9.44782C12.7328 9.44782 12.4922 9.21185 12.4922 8.92118V1.52664C12.4922 1.23598 12.7328 1 13.0292 1C13.3256 1 13.5662 1.23598 13.5662 1.52664V8.92113C13.5662 9.21179 13.3256 9.44782 13.0292 9.44782Z"
                      fill="#222222"
                      stroke="#222222"
                      stroke-width="0.4"
                    />
            ...
            <div className={styles.managementActions}>
              <div className={styles.managementItem}>
                <div className={styles.SvgDesign}>
                  ...
                  >
                    <path
                      d="M11.3946 8.66042L1.84919 14.8131C1.03875 15.3355 0 14.7036 0 13.6527V1.34733C0 0.296354 1.03875 -0.335462 1.84919 0.186917L11.3946 6.33958C12.2018 6.85984 12.2018 8.14016 11.3946 8.66042Z"
                      fill="#6524EB"
                    />
                  </svg>
                </div>
