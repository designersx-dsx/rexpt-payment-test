                ...
                <div className={styles.DataMain}>
                    ...
                    <div className={styles.moredetailsDiv}>
                        ...
                        <div className={styles.channel}>
                            ...
                            <div className={styles.PhoneDiv2}>
                                <img src='svg/Play-icon2.svg' alt='Play-icon2' />
                            </div>
                        </div>
                    </div>
                    <div className={styles.summaryDiv}>
                        ...
                        <p className={styles.Ptext}>Customer inquired about product availability and pricing. Agent provided detailed information and offered a discount.</p>
                    </div>
                    <div className={styles.summaryDiv}>
                        <div className={styles.dataTitle}>
                            <h2>Chat Details</h2>
                    ...
                    <div className={styles.summaryDiv}>
                        ...
                        <p className={styles.Ptext}>Analysis: Customer satisfied with the information provided. </p>
                    </div>
                </div>
            </section>
        </div>
