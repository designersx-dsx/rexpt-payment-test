...
const EditProfile = () => {
  ...
  const handleUpload = (imageUrl) => {
    ...
    //       profile:
    //         `${API_BASE_URL?.split("/api")[0]}${formData?.profilePicture?.split("public")[1]
    //         }`,
    //       })
    setFormData((prev) => ({
      ...prev,
 ...
 { loading?<Loader2/>:  <div className={styles.card}>
      <div className={styles.backIcon}>
        <img src='svg/Notification.svg' alt='Back-icon' className={styles.imageIcon} onClick={handleBack} />
      </div>
