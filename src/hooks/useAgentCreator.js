...
//         Use the extract_user_details tool to extract the user's name, email, phone, address, and reason for calling from the conversation.

//         {{tool: extract_user_details}}
